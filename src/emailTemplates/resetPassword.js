module.exports = function (name, resetLink) {
  return `
          ...
          <table width="480" cellpadding="0" cellspacing="0" style="background:#fff; border-radius:16px; margin:2rem 0; box-shadow:0 8px 32px rgba(209,77,114,0.08);">
            <tr>
              <td align="center" style="padding:2rem 1.5rem 0 1.5rem;">
                ...
                <h1 style="color:#d14d72; font-size:2rem; margin-bottom:0.5rem;">Redefinição de Senha</h1>
                <p style="color:#222; font-size:1.1rem; margin-bottom:1.5rem;">
                  Olá, <b>${name}</b>!<br/>
                  Recebemos uma solicitação para redefinir sua senha na Center Pet.<br/>
                  Se não foi você, ignore este e-mail.
                </p>
                <a href="${resetLink}" style="display:inline-block; background:#d14d72; color:#fff; padding:0.9rem 2.2rem; border-radius:8px; font-weight:bold; text-decoration:none; font-size:1.08rem; margin-bottom:1.5rem;">
                  Redefinir Senha
                </a>
